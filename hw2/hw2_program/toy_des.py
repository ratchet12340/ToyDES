...
class ToyDES:
    ...
    If desired, can change the 10-bit key that is used via set_key().
    """
    ...
    def set_key(self, key):
        """
        When using ToyDES, a key must be provided to generate subkeys.
        This key is a 10 bit number. This method allows for reusing a ToyDES
        object, yet change the key used.
        """
